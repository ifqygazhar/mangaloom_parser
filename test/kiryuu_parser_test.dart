...
/// Full scraping health-check for the Kiryuu (ID) source.
void main() {
  ...
  group('KiryuuParser - Full Scraping Health Check', () {
    ...
    test('fetchPopular', () async {
      final ok = await runScrape('fetchPopular', () async {
        ...
        // ignore: avoid_print
        print('   [Kiryuu] fetchPopular -> ${items.length} items');
    ...
    test('fetchNewest', () async {
      final ok = await runScrape('fetchNewest', () async {
        ...
        // ignore: avoid_print
        print('   [Kiryuu] fetchNewest -> ${items.length} items');
        expect(items, isNotEmpty);
      });
    ...
    test('search', () async {
      final ok = await runScrape('search', () async {
        ...
        // ignore: avoid_print
        print('   [Kiryuu] search -> ${items.length} items');
      });
    ...
    test('fetchGenres', () async {
      final ok = await runScrape('fetchGenres', () async {
        ...
        // ignore: avoid_print
        print('   [Kiryuu] fetchGenres -> ${genres.length} genres');
    ...
    test('fetchDetail + fetchChapter', () async {
      final ok = await runScrape('fetchDetail+Chapter', () async {
        ...
        // ignore: avoid_print
        print('   [Kiryuu] fetchDetail -> "${detail.title}" | '
        ...
        // ignore: avoid_print
        print('   [Kiryuu] fetchChapter -> "${chapter.title}" | '
    ...
    test('PRINT FINAL SUMMARY', () {
      ...
      print('\n══════════════════════════════════════════════════');
      // ignore: avoid_print
      print('   KIRYUU SOURCE SCRAPING SUMMARY');
      // ignore: avoid_print
      print('══════════════════════════════════════════════════');
      var pass = 0;
